...
export const CATEGORY_META: Record<string, { icon: string; color: string }> = {
  '意象': { icon: 'flare',          color: 'bg-indigo-100 text-indigo-700 border-indigo-200' },
  '实物': { icon: 'inventory_2',    color: 'bg-amber-100 text-amber-700 border-amber-200' },
  '动作': { icon: 'directions_run', color: 'bg-emerald-100 text-emerald-700 border-emerald-200' },
  '状态': { icon: 'masks',          color: 'bg-pink-100 text-pink-700 border-pink-200' },
  '感官': { icon: 'visibility',     color: 'bg-cyan-100 text-cyan-700 border-cyan-200' },
  '抽象': { icon: 'psychology',     color: 'bg-violet-100 text-violet-700 border-violet-200' },
  '人物': { icon: 'person',         color: 'bg-orange-100 text-orange-700 border-orange-200' },
  '地名': { icon: 'map',            color: 'bg-teal-100 text-teal-700 border-teal-200' },
  '典故': { icon: 'history_edu',    color: 'bg-stone-100 text-stone-700 border-stone-200' },
};
